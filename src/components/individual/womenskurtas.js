...
function Womenskurtas() {
    ...
    function price() {
        setwomenskurta([...womenskurta.sort((a,b) => a.price > b.price ? 1 : -1)])

        console.log(womenskurta)
        // setSarees(a)
    }
    function discount() {
        setwomenskurta([...womenskurta.sort((a,b) => a.discount > b.discount ? -1 : 1)])
    ...
    return (
        <div>
        <h1 className='display-1'>Womens Kurta</h1>
        <div className='row'>
